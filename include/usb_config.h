...
********************************************************************
 ...
 Change History:
  ...
  2.1   02/26/2007   Updated for simplicity and to use common
                     coding style
  2.1p  03/11/2010   Adopted for the PICCOLO project - I. Cserny
 *******************************************************************/
...
//-- Automatically select between polling/interrupt mode 
//-- depending on the definition of symbol USE_INTERRUPT
...
//-- Define priority of the USB Interrupt (0:low, 1:high)
#define USB_ISR_PRIORITY	1
